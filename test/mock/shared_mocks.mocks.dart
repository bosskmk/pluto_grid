...
class _FakePlutoChangeNotifierFilter_14<T1> extends _i1.SmartFake
    implements _i2.PlutoChangeNotifierFilter<T1> {
...
class MockPlutoGridStateManager extends _i1.Mock
  ...
  @override
  void finishCellDrag() => super.noSuchMethod(
        Invocation.method(
          #finishCellDrag,
          [],
        ),
