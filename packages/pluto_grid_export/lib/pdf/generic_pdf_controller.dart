...
import 'package:pluto_grid_export/pdf/pdf_controller.dart';
...
class GenericPdfController extends PdfController {
  ...
  Widget _table(List<String> columms, List<List<String?>> rows) {
    return Table.fromTextArray(
        border: null,
        cellAlignment: Alignment.center,
        // FIXME Awaiting for https://github.com/DavBfr/dart_pdf/pull/1033 to replace "headerDecoration" with "headerCellDecoration"
  ...
  ThemeData getThemeData() {
    // HINT you can set here custom fonts
    // ThemeData.withFont(
    // base: Font.ttf(await rootBundle.load('fonts/Roboto-Regular.ttf')),
    // bold: Font.ttf(await rootBundle.load('fonts/Roboto-Bold.ttf')),
    // )
