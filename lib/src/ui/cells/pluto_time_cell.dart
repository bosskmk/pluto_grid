    ...
    PlutoDualGridPopup(
      ...
      gridPropsA: PlutoDualGridProps(
        ...
        onLoaded: (PlutoGridOnLoadedEvent event) {
          ...
          for (var i = 0; i < event.stateManager.rowsToDisplay.length; i += 1) {
            if (event.stateManager.rowsToDisplay[i].cells['hour']!.value ==
                cellHour) {
              event.stateManager.setCurrentCell(
                  event.stateManager.rowsToDisplay[i].cells['hour'], i);
      ...
      gridPropsB: PlutoDualGridProps(
        ...
        onLoaded: (PlutoGridOnLoadedEvent event) {
          ...
          for (var i = 0; i < event.stateManager.rowsToDisplay.length; i += 1) {
            if (event.stateManager.rowsToDisplay[i].cells['minute']!.value ==
                cellMinute) {
              event.stateManager.setCurrentCell(
                  event.stateManager.rowsToDisplay[i].cells['minute'], i);
